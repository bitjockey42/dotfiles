...
`dotspacemacs/user-config' first."
  ...
  ;; ---------------------------------------------------------------------
  ;; Set different fonts for particular modes
  ...
  ;; (add-hook 'writeroom-mode-hook 'my-buffer-face-mode-variable)

  ;; Org-mode
  (setq org-pretty-entities t)

  ;; To get the right status colors in OS X
...
you should place you code here."
  ...
  (setq calendar-location-name "Midwest United States"
        calendar-latitude 41.94
        calendar-longitude -87.66)

  ;; Powerline has to be explicitly set in server mode
